    ...
    <div id="header">
        <div id="banner-area">
            ...
            <div id="ccsa-area">
                ...
                <br /><a href="https://www.usgs.gov/" title="Link to main USGS page">USGS Home</a>
                <br /><a href="https://answers.usgs.gov/cgi-bin/gsanswers?tmplt=2" title="Link to main USGS contact page">Contact USGS</a>
            </div>
        </div><!-- End content -->
        
        <h2 id="site-title"><a href='${param["baseUrl"]}'>Environmental Data Discovery and Transformation - BETA</a></h2>
    </div><!-- /header -->
</div><!--/header panel-->
