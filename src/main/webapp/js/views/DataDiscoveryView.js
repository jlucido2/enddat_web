...
define([
	...
	var view = BaseView.extend({
		...
		render : function() {
			...
			this.listenTo(this.model, 'change:datasetDateFilter', this.showSuccessfulFetchAlert);
		...
		_filterMsg : function() {
			...
			var aoi = state.aoi;
			var dateFilter = this.model.has('datasetDateFilter') ? state.datasetDateFilter : {};
