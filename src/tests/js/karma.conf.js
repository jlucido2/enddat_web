...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'src/main/webapp/js/bower_components/underscore/underscore.js', included: false},
      {pattern: 'src/main/webapp/js/bower_components/backbone/backbone.js', included: false},
      {pattern: 'src/main/webapp/js/bower_components/bootstrap/dist/js/bootstrap.js', included: false},
      {pattern: 'src/main/webapp/js/bower_components/handlebars/handlebars.amd.js', included: false},
      {pattern: 'src/main/webapp/js/bower_components/text/text.js', included: false},
